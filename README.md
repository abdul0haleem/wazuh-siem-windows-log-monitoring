...
- [Lab Architecture](#️-lab-architecture)
  - [Lab Network Architecture](#-lab-network-architecture)
- [Objectives](#-objectives)
- [Lab Environment](#️-lab-environment)
- [Tools Used](#️-tools-used)
- [Step 1: Download the Wazuh OVA](#step-1-download-the-wazuh-ova)
- [Step 2: Import the Wazuh OVA into VirtualBox](#step-2-import-the-wazuh-ova-into-virtualbox)
  - [2.1 Open VirtualBox](#21-open-virtualbox)
  - [2.2 Start the Import](#22-start-the-import)
  - [2.3 Review the Appliance Settings](#23-review-the-appliance-settings)
  - [2.4 Verify the Virtual Machine](#24-verify-the-virtual-machine)
- [Step 3: Configure the Wazuh Server Network](#step-3-configure-the-wazuh-server-network)
  - [3.1 Configure the Wazuh Server](#31-configure-the-wazuh-server)
  - [3.2 Configure Kali Linux](#32-configure-kali-linux)
  - [3.3 Configure Windows 11 Network](#33-configure-windows-11-network)
  - [3.4 Network Architecture](#34-network-architecture)
- [Step 4: Start the Wazuh Server and Find Its IP Address](#step-4-start-the-wazuh-server-and-find-its-ip-address)
  - [4.1 Start the Wazuh Server](#41-start-the-wazuh-server)
  - [4.2 Log in to the Wazuh Server](#42-log-in-to-the-wazuh-server)
  - [4.3 Find the IP Address](#43-find-the-ip-address)
- [Step 5: Verify Connectivity from Kali Linux to the Wazuh Server](#step-5-verify-connectivity-from-kali-linux-to-the-wazuh-server)
  - [5.1 Start Kali Linux](#51-start-kali-linux)
  - [5.2 Check the Kali Linux IP Address](#52-check-the-kali-linux-ip-address)
  - [5.3 Ping the Wazuh Server](#53-ping-the-wazuh-server)
- [Step 6: Access the Wazuh Dashboard from Kali Linux](#step-6-access-the-wazuh-dashboard-from-kali-linux)
  - [6.1 Open the Browser](#61-open-the-browser)
  - [6.2 Accept the Security Warning](#62-accept-the-security-warning)
  - [6.3 Log in to Wazuh](#63-log-in-to-wazuh)
- [Step 7: Verify Wazuh Services](#step-7-verify-wazuh-services)
  - [7.1 Open the Wazuh Server Terminal](#71-open-the-wazuh-server-terminal)
  - [7.2 Check the Wazuh Manager](#72-check-the-wazuh-manager)
  - [7.3 Check the Wazuh Indexer](#73-check-the-wazuh-indexer)
  - [7.4 Check the Wazuh Dashboard](#74-check-the-wazuh-dashboard)
  - [Service Verification Summary](#service-verification-summary)
- [Step 8: Check Windows 11 → Wazuh Server Connectivity](#step-8-check-windows-11--wazuh-server-connectivity)
  - [8.1 Start Windows 11](#81-start-windows-11)
  - [8.2 Find the Windows 11 IP Address](#82-find-the-windows-11-ip-address)
  - [8.3 Test Connectivity to the Wazuh Server](#83-test-connectivity-to-the-wazuh-server)
  - [Network Connectivity](#network-connectivity)
- [Step 9: Download and Install the Wazuh Agent for Windows 11](#step-9-download-and-install-the-wazuh-agent-for-windows-11)
  - [9.1 Open the Wazuh Dashboard](#91-open-the-wazuh-dashboard)
  - [9.2 Open Agent Deployment](#92-open-agent-deployment)
  - [9.3 Configure the Windows Agent](#93-configure-the-windows-agent)
  - [9.4 Copy the Installation Command](#94-copy-the-installation-command)
  - [9.5 Open PowerShell as Administrator](#95-open-powershell-as-administrator)
  - [9.6 Download and Install the Agent](#96-download-and-install-the-agent)
  - [9.7 Verify the Installation](#97-verify-the-installation)
- [Step 10: Start the Wazuh Agent](#step-10-start-the-wazuh-agent)
  - [10.1 Start the Wazuh Agent](#101-start-the-wazuh-agent)
  - [10.2 Verify the Agent Status](#102-verify-the-agent-status)
- [Step 11: Verify Windows Security Events](#step-11-verify-windows-security-events)
  - [11.1 Open the Windows Agent](#111-open-the-windows-agent)
  - [11.2 Open the Events View](#112-open-the-events-view)
  - [11.3 Filter Events for the Windows Agent](#113-filter-events-for-the-windows-agent)
